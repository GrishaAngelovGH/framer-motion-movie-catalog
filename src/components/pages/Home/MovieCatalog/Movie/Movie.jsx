  ...
  return (
    <div className="flex">
      <div className="text-center">
        <motion.div whileHover={{ scale: 1.1 }} className="relative m-8 mb-0 md:w-[160px] lg:w-[220px]">
          {
            isFavorite && (
              <motion.div
                initial={{ opacity: "0%" }}
      ...
      {
        isFavoriteMovie ? (
          <motion.svg initial={{ opacity: 0 }} animate={{ opacity: "100%" }} transition={{ duration: 1, delay: 4 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-white mt-8 cursor-pointer">
            <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" clipRule="evenodd" />
          </motion.svg>
        ) : (
          <motion.svg initial={{ opacity: 0 }} animate={{ opacity: "100%" }} transition={{ duration: 1, delay: 4 }} onClick={handleMarkAsFavorite} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-white mt-8 cursor-pointer">
