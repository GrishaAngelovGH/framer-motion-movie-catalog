    ...
    <motion.div
      ...
      <div className="mt-2 bg-gray-100 rounded-md p-2 flex flex-col items-center">
        <div className="flex items-center">
          <button onClick={handleIncrement} className="bg-blue-500 text-white p-1 rounded-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
            </svg>
          </button>
          <span className="mx-3">Quantity: {qty}</span>
          <button onClick={handleDecrement} className="bg-blue-500 text-white p-1 rounded-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
      ...
      <button onClick={() => { controls.start("visible") }} className="bg-red-500 hover:bg-red-600 text-white mt-5 p-1 w-full flex justify-center cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
