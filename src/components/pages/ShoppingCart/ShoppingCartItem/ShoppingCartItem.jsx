const ShoppingCartItem = ({ title, products, qty, comboPrice, totalPrice }) => {
  return (
    <div className="bg-gray-200 shadow-lg p-5 rounded-md text-xl">
      <div className="text-center">{title}</div>
      <div className="mt-5 flex justify-evenly gap-5">
        {
          products.map((v, i) => (
      ...
      <button className="bg-red-500 hover:bg-red-600 text-white mt-5 p-1 w-full flex justify-center">
